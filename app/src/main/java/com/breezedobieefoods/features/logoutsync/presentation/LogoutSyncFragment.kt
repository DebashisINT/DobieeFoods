package com.breezedobieefoods.features.logoutsync.presentation
...
import com.breezedobieefoods.app.AppDatabase
...
import com.breezedobieefoods.app.utils.Toaster
import com.breezedobieefoods.base.BaseResponse
import com.breezedobieefoods.base.presentation.BaseActivity
import com.breezedobieefoods.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezedobieefoods.features.billing.api.AddBillingRepoProvider
import com.breezedobieefoods.features.billing.model.AddBillingInputParamsModel
...
import com.breezedobieefoods.features.dashboard.presentation.ReasonDialog
...
import com.breezedobieefoods.features.document.model.AddEditDocumentInputParams
import com.breezedobieefoods.features.document.model.DocumentAttachmentModel
...
import com.breezedobieefoods.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezedobieefoods.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezedobieefoods.features.orderhistory.model.*
...
import com.breezedobieefoods.features.quotation.model.AddQuotInputModel
...
import com.breezedobieefoods.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezedobieefoods.features.timesheet.model.AddTimeSheetInputModel
...
import com.breezedobieefoods.MonitorService
import com.breezedobieefoods.MySingleton
import com.breezedobieefoods.app.AlarmReceiver
import com.breezedobieefoods.features.addshop.model.*
import com.breezedobieefoods.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezedobieefoods.features.addshop.presentation.ShopExtraContactReq
import com.breezedobieefoods.features.addshop.presentation.multiContactRequestData
import com.breezedobieefoods.features.contacts.CallHisDtls
import com.breezedobieefoods.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezedobieefoods.features.login.model.GetConcurrentUserResponse
...
import com.breezedobieefoods.features.orderITC.SyncDeleteOpptL
import com.breezedobieefoods.features.orderITC.SyncEditOppt
import com.breezedobieefoods.features.orderITC.SyncOppt
import com.breezedobieefoods.features.orderITC.SyncOpptProductL
import com.breezedobieefoods.features.orderITC.SyncOrd
import com.breezedobieefoods.features.orderITC.SyncOrdProductL
import com.breezedobieefoods.features.performance.model.Gps_status_list
import com.breezedobieefoods.features.performance.model.UpdateGpsInputListParamsModel
import com.breezedobieefoods.features.returnsOrder.ReturnProductList
import com.breezedobieefoods.features.returnsOrder.ReturnRequest
import com.breezedobieefoods.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedobieefoodslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedobieefoodslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedobieefoodslogsample/log.zip").path);
