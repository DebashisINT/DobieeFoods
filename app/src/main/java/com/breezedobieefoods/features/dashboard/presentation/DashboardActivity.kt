package com.breezedobieefoods.features.dashboard.presentation
...
import com.breezedobieefoods.*
import com.breezedobieefoods.R
import com.breezedobieefoods.app.*
import com.breezedobieefoods.app.NewFileUtils.browseDocuments
import com.breezedobieefoods.app.NewFileUtils.browsePDFDocuments
import com.breezedobieefoods.app.NewFileUtils.getExtension
import com.breezedobieefoods.app.domain.*
import com.breezedobieefoods.app.types.DashboardType
import com.breezedobieefoods.app.types.FragType
import com.breezedobieefoods.app.types.TopBarConfig
import com.breezedobieefoods.app.uiaction.DisplayAlert
import com.breezedobieefoods.app.utils.*
import com.breezedobieefoods.app.utils.AppUtils.Companion.isProfile
...
import com.breezedobieefoods.features.NewQuotation.*
import com.breezedobieefoods.features.NewQuotation.api.GetQuotRegProvider
import com.breezedobieefoods.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezedobieefoods.features.SearchLocation.SearchLocationFragment
import com.breezedobieefoods.features.SearchLocation.locationInfoModel
import com.breezedobieefoods.features.TA.ViewAllTAListFragment
import com.breezedobieefoods.features.achievement.AchievementFragment
import com.breezedobieefoods.features.activities.presentation.*
import com.breezedobieefoods.features.addAttendence.*
import com.breezedobieefoods.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezedobieefoods.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezedobieefoods.features.addAttendence.model.GetReportToFCMResponse
import com.breezedobieefoods.features.addAttendence.model.GetReportToResponse
import com.breezedobieefoods.features.addAttendence.model.Leave_list_Response
import com.breezedobieefoods.features.addorder.presentation.AddOrderFragment
...
import com.breezedobieefoods.features.addshop.presentation.AddShopFragment
import com.breezedobieefoods.features.addshop.presentation.OTPVerificationDialog
import com.breezedobieefoods.features.addshop.presentation.ScanImageFragment
import com.breezedobieefoods.features.addshop.presentation.ShowCardDetailsDialog
import com.breezedobieefoods.features.alarm.model.AlarmData
import com.breezedobieefoods.features.alarm.presetation.AttendanceReportFragment
import com.breezedobieefoods.features.alarm.presetation.PerformanceReportFragment
import com.breezedobieefoods.features.alarm.presetation.VisitReportDetailsFragment
import com.breezedobieefoods.features.alarm.presetation.VisitReportFragment
import com.breezedobieefoods.features.attendance.AttendanceFragment
import com.breezedobieefoods.features.attendance.api.AttendanceRepositoryProvider
import com.breezedobieefoods.features.attendance.model.AttendanceRequest
import com.breezedobieefoods.features.attendance.model.AttendanceResponse
import com.breezedobieefoods.features.averageshop.presentation.AverageShopFragment
import com.breezedobieefoods.features.avgorder.presentation.AverageOrderFragment
import com.breezedobieefoods.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezedobieefoods.features.beatCustom.TeamBeatListFragment
import com.breezedobieefoods.features.billing.presentation.AddBillingFragment
import com.breezedobieefoods.features.billing.presentation.BillingDetailsFragment
import com.breezedobieefoods.features.billing.presentation.BillingListFragment
import com.breezedobieefoods.features.changepassword.presentation.ChangePasswordDialog
import com.breezedobieefoods.features.chat.model.ChatListDataModel
import com.breezedobieefoods.features.chat.model.ChatUserDataModel
import com.breezedobieefoods.features.chat.model.GroupUserDataModel
import com.breezedobieefoods.features.chat.presentation.*
import com.breezedobieefoods.features.chatbot.presentation.ChatBotFragment
import com.breezedobieefoods.features.chatbot.presentation.ChatBotShopListFragment
import com.breezedobieefoods.features.chatbot.presentation.ReportsFragment
import com.breezedobieefoods.features.chatbot.presentation.SelectLanguageDialog
import com.breezedobieefoods.features.commondialog.presentation.CommonDialog
import com.breezedobieefoods.features.commondialog.presentation.CommonDialogClickListener
import com.breezedobieefoods.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezedobieefoods.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezedobieefoods.features.commondialogsinglebtn.OnDialogClickListener
import com.breezedobieefoods.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezedobieefoods.features.contacts.ActivityDtlsFrag
import com.breezedobieefoods.features.contacts.AddOpptFrag
import com.breezedobieefoods.features.contacts.ContactDtls
import com.breezedobieefoods.features.contacts.ContactGr
import com.breezedobieefoods.features.contacts.ContactsAddFrag
import com.breezedobieefoods.features.contacts.ContactsFrag
import com.breezedobieefoods.features.contacts.SchedulerAddFormFrag
import com.breezedobieefoods.features.contacts.SchedulerViewFrag
import com.breezedobieefoods.features.contacts.TemplateAddFrag
import com.breezedobieefoods.features.contacts.TemplateViewFrag
import com.breezedobieefoods.features.contacts.ViewCrmOpptFrag
import com.breezedobieefoods.features.dailyPlan.prsentation.AllShopListFragment
import com.breezedobieefoods.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezedobieefoods.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezedobieefoods.features.damageProduct.ShopDamageProductListFrag
import com.breezedobieefoods.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezedobieefoods.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezedobieefoods.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezedobieefoods.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezedobieefoods.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezedobieefoods.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezedobieefoods.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezedobieefoods.features.dashboard.presentation.model.ContentListResponseModel
import com.breezedobieefoods.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezedobieefoods.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezedobieefoods.features.device_info.presentation.DeviceInfoListFragment
import com.breezedobieefoods.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezedobieefoods.features.document.DocumentRepoFeatureNewFragment
import com.breezedobieefoods.features.document.presentation.DocumentListFragment
import com.breezedobieefoods.features.document.presentation.DocumentTypeListFragment
import com.breezedobieefoods.features.document.presentation.OpenFileWebViewFragment
import com.breezedobieefoods.features.dymanicSection.presentation.AddDynamicFragment
import com.breezedobieefoods.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezedobieefoods.features.dymanicSection.presentation.DynamicListFragment
import com.breezedobieefoods.features.dymanicSection.presentation.EditDynamicFragment
import com.breezedobieefoods.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezedobieefoods.features.home.presentation.HomeFragment
import com.breezedobieefoods.features.homelocation.presentation.HomeLocationFragment
import com.breezedobieefoods.features.homelocation.presentation.HomeLocationMapFragment
import com.breezedobieefoods.features.know_your_state.KnowYourStateFragment
import com.breezedobieefoods.features.lead.LeadFrag
import com.breezedobieefoods.features.lead.ViewLeadFrag
import com.breezedobieefoods.features.leaderboard.LeaderBoardFrag
import com.breezedobieefoods.features.leaveapplynew.LeaveHome
import com.breezedobieefoods.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezedobieefoods.features.localshops.LocalShopListFragment
import com.breezedobieefoods.features.localshops.LocalShopListMapFragment
import com.breezedobieefoods.features.localshops.NearByShopsMapFragment
import com.breezedobieefoods.features.location.*
import com.breezedobieefoods.features.location.api.LocationRepoProvider
import com.breezedobieefoods.features.location.model.*
import com.breezedobieefoods.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezedobieefoods.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezedobieefoods.features.login.ShopFeedbackEntity
import com.breezedobieefoods.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezedobieefoods.features.login.presentation.LoginActivity
import com.breezedobieefoods.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezedobieefoods.features.logoutsync.presentation.LogoutSyncFragment
import com.breezedobieefoods.features.marketAssist.MarketAssistTabFrag
import com.breezedobieefoods.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezedobieefoods.features.marketAssist.ShopListMarketAssistFrag
import com.breezedobieefoods.features.marketing.presentation.MarketingPagerFragment
import com.breezedobieefoods.features.meetinglist.prsentation.MeetingListFragment
import com.breezedobieefoods.features.member.MapViewForTeamFrag
import com.breezedobieefoods.features.member.model.TeamLocDataModel
import com.breezedobieefoods.features.member.model.TeamShopListDataModel
import com.breezedobieefoods.features.member.presentation.*
import com.breezedobieefoods.features.menuBeat.MenuBeatFrag
import com.breezedobieefoods.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezedobieefoods.features.micro_learning.presentation.MicroLearningListFragment
import com.breezedobieefoods.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezedobieefoods.features.myallowancerequest.MyallowanceRequestFragment
import com.breezedobieefoods.features.myjobs.model.CustomerDataModel
import com.breezedobieefoods.features.myjobs.presentation.*
import com.breezedobieefoods.features.mylearning.MyLearningFragment
import com.breezedobieefoods.features.myorder.presentation.MyOrderListFragment
import com.breezedobieefoods.features.myprofile.presentation.MyProfileFragment
import com.breezedobieefoods.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezedobieefoods.features.nearbyshops.model.ShopData
import com.breezedobieefoods.features.nearbyshops.model.ShopListResponse
import com.breezedobieefoods.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezedobieefoods.features.nearbyshops.presentation.BeatListFragment
import com.breezedobieefoods.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezedobieefoods.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezedobieefoods.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezedobieefoods.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezedobieefoods.features.newcollection.CollectionDetailsStatusFragment
import com.breezedobieefoods.features.newcollection.CollectionShopListFragment
import com.breezedobieefoods.features.newcollection.NewCollectionListFragment
import com.breezedobieefoods.features.newcollectionreport.*
import com.breezedobieefoods.features.notification.NotificationFragment
import com.breezedobieefoods.features.orderITC.CartListFrag
import com.breezedobieefoods.features.orderITC.OrderListFrag
import com.breezedobieefoods.features.orderITC.ProductListFrag
import com.breezedobieefoods.features.orderITC.ViewNewOrdHisAllFrag
import com.breezedobieefoods.features.orderITC.ViewNewOrdHistoryFrag
import com.breezedobieefoods.features.orderITC.ViewOrdDtls
import com.breezedobieefoods.features.orderList.NewDateWiseOrderListFragment
import com.breezedobieefoods.features.orderList.NewOrderListFragment
import com.breezedobieefoods.features.orderList.OrderListFragment
import com.breezedobieefoods.features.orderdetail.presentation.OrderDetailFragment
import com.breezedobieefoods.features.orderhistory.ActivityMapFragment
import com.breezedobieefoods.features.orderhistory.OrderhistoryFragment
import com.breezedobieefoods.features.orderhistory.TimeLineFragment
import com.breezedobieefoods.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezedobieefoods.features.orderhistory.model.LocationData
import com.breezedobieefoods.features.pendinglocationinout.PendingOutLocationFrag
import com.breezedobieefoods.features.performance.GpsStatusFragment
import com.breezedobieefoods.features.performance.PerformanceFragment
import com.breezedobieefoods.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezedobieefoods.features.performance.model.UpdateGpsInputParamsModel
import com.breezedobieefoods.features.performanceAPP.OwnPerformanceFragment
import com.breezedobieefoods.features.performanceAPP.PerformanceAppFragment
import com.breezedobieefoods.features.performanceAPP.allPerformanceFrag
import com.breezedobieefoods.features.permissionList.ViewPermissionFragment
import com.breezedobieefoods.features.photoReg.*
import com.breezedobieefoods.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezedobieefoods.features.quotation.presentation.*
import com.breezedobieefoods.features.reimbursement.presentation.*
import com.breezedobieefoods.features.report.presentation.*
import com.breezedobieefoods.features.returnsOrder.*
import com.breezedobieefoods.features.settings.presentation.SettingsFragment
import com.breezedobieefoods.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezedobieefoods.features.shopdetail.presentation.*
import com.breezedobieefoods.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezedobieefoods.features.stock.StockDetailsFragment
import com.breezedobieefoods.features.stock.StockListFragment
import com.breezedobieefoods.features.stockAddCurrentStock.AddShopStockFragment
import com.breezedobieefoods.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezedobieefoods.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezedobieefoods.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezedobieefoods.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezedobieefoods.features.stockCompetetorStock.CompetetorStockFragment
import com.breezedobieefoods.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezedobieefoods.features.survey.SurveyFrag
import com.breezedobieefoods.features.survey.SurveyViewDtlsFrag
import com.breezedobieefoods.features.survey.SurveyViewFrag
import com.breezedobieefoods.features.task.presentation.AddTaskFragment
import com.breezedobieefoods.features.task.presentation.CalenderTaskFragment
import com.breezedobieefoods.features.task.presentation.EditTaskFragment
import com.breezedobieefoods.features.task.presentation.TaskListFragment
import com.breezedobieefoods.features.taskManagement.TaskManagementFrag
import com.breezedobieefoods.features.taskManagement.ViewTaskManagementFrag
import com.breezedobieefoods.features.timesheet.presentation.AddTimeSheetFragment
import com.breezedobieefoods.features.timesheet.presentation.EditTimeSheetFragment
import com.breezedobieefoods.features.timesheet.presentation.TimeSheetListFragment
import com.breezedobieefoods.features.viewAllOrder.CartFragment
import com.breezedobieefoods.features.viewAllOrder.OrderTypeListFragment
import com.breezedobieefoods.features.viewAllOrder.ViewAllOrderListFragment
import com.breezedobieefoods.features.viewAllOrder.ViewCartFragment
import com.breezedobieefoods.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezedobieefoods.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezedobieefoods.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezedobieefoods.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezedobieefoods.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezedobieefoods.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezedobieefoods.features.viewPPDDStock.ViewOutstandingFragment
import com.breezedobieefoods.features.viewPPDDStock.ViewPPDDListFragment
import com.breezedobieefoods.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezedobieefoods.features.viewPPDDStock.ViewStockFragment
import com.breezedobieefoods.features.weather.presentation.WeatherFragment
import com.breezedobieefoods.mappackage.MapActivity
import com.breezedobieefoods.mappackage.MapActivityWithoutPath
import com.breezedobieefoods.mappackage.SendBrod
import com.breezedobieefoods.widgets.AppCustomEditText
import com.breezedobieefoods.widgets.AppCustomTextView
...
import com.breezedobieefoods.features.login.api.opportunity.OpportunityRepoProvider
import com.breezedobieefoods.features.login.model.NewSettingsResponseModel
import com.breezedobieefoods.features.mylearning.AllTopicsWiseContents
import com.breezedobieefoods.features.mylearning.BookmarkFetchResponse
import com.breezedobieefoods.features.mylearning.BookmarkFrag
import com.breezedobieefoods.features.mylearning.BookmarkPlayFrag
import com.breezedobieefoods.features.mylearning.KnowledgeHubAllVideoList
import com.breezedobieefoods.features.mylearning.LeaderboardLmsFrag
import com.breezedobieefoods.features.mylearning.LmsQuestionAnswerSet
import com.breezedobieefoods.features.mylearning.MyLearningAllVideoList
import com.breezedobieefoods.features.mylearning.MyLearningTopicList
import com.breezedobieefoods.features.mylearning.MyLearningVideoPlay
import com.breezedobieefoods.features.mylearning.MyPerformanceFrag
import com.breezedobieefoods.features.mylearning.MyTopicsWiseContents
import com.breezedobieefoods.features.mylearning.NotificationLMSFragment
import com.breezedobieefoods.features.mylearning.SearchLmsFrag
import com.breezedobieefoods.features.mylearning.SearchLmsKnowledgeFrag
import com.breezedobieefoods.features.mylearning.SearchLmsLearningFrag
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezedobieefoodslogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedobieefoodslogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezedobieefoods/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezedobieefoodslogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezedobieefoodslogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezedobieefoodslogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
