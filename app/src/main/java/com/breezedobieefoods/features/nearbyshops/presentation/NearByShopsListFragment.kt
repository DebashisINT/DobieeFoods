package com.breezedobieefoods.features.nearbyshops.presentation
...
import com.breezedobieefoods.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezedobieefoods.app.utils.FTStorageUtils
import com.breezedobieefoods.app.utils.NotificationUtils
...
import com.breezedobieefoods.features.addshop.model.AssignedToShopListResponseModel
import com.breezedobieefoods.features.addshop.model.QuestionSubmit
import com.breezedobieefoods.features.addshop.model.UpdateAddrReq
import com.breezedobieefoods.features.addshop.model.UpdateAddressShop
...
import com.breezedobieefoods.features.addshop.presentation.*
...
import com.breezedobieefoods.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezedobieefoods.features.marketing.model.MarketingCategoryListResponse
...
import com.breezedobieefoods.features.nearbyshops.model.StageListResponseModel
...
import com.breezedobieefoods.features.shopdetail.presentation.AddCollectionDialog
...
//                            val uri = Uri.fromFile(file)
               ...
               val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezedobieefoods/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
